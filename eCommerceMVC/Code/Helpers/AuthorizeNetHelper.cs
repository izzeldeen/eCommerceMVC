...
namespace eCommerceMVC.Code.Helpers
{
    public static class AuthorizeNetHelper
    {
        ...
        {
            _ApiLoginID = ConfigurationManager.AppSettings["AuthorizeNet_ApiLoginID"];
            _ApiTransactionKey = ConfigurationManager.AppSettings["AuthorizeNet_ApiTransactionKey"];
            _SandBox = ConfigurationManager.AppSettings["AuthorizeNet_SandBox"].ToLower() == "true";
